...
public class Sport implements Serializable {
    ...
    @ManyToMany
    private List<Person> personsPractisingSport;
    ...
    public void setPersonsPractisingSport(List<Person> personsPractisingSport) {
        this.personsPractisingSport = personsPractisingSport;
    }
